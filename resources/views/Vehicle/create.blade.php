@extends('layouts.app', ['activePage' => 'create-vehicle', 'titlePage' => __('Registro Vehiculos')])
                                    ...
                                    <label class="col-sm-2 col-form-label">  </label>
                                        <div class="fileinput fileinput-new text-center " required data-provides="fileinput">
                                            <div class="fileinput-new thumbnail img-circle">
                                                <img
                                                    src="https://material-dashboard-pro-laravel.creative-tim.com/material/img/placeholder.jpg"
                                                    alt="...">
                                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-7">
                                        <div
                                            ...
                                            {!! Form::select('driverId',$driver,null,['class'=>"selectpicker show-tick ", $errors->has('driverId') ? ' is-invalid' : '' ,
...
{{--                                    <div class="col-sm-7">--}}
                                        <div
                                            ...
                                            <label for="input-status"
                                                   class="bmd-label-floating">{{ __('') }}</label>
                                            {!! Form::select('status',$statu,null,['class'=>"selectpicker show-tick ", $errors->has('status') ? ' is-invalid' : '' ,
